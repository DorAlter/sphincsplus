...
#define ROTR32(x, y) _mm256_ror_epi32(x,y)
#define ROTL32(x, y) _mm256_rol_epi32(x,y)
...
#define MAJ_AVX(a, b, c) _mm256_ternarylogic_epi32(a,b,c,0xE8)
#define CH_AVX(a, b, c) _mm256_ternarylogic_epi32(a,b,c,0xCA)
